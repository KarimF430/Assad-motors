...
export const metadata: Metadata = {
    title: 'Used Cars in India - Buy Second Hand Cars at Best Prices | Assad Motors',
    ...
    openGraph: {
        title: 'Used Cars in India - Buy Second Hand Cars | Assad Motors',
